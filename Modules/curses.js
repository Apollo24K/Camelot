...
const curses = [
    ...
    new curseInfo("Gravity Manipulation", 11, "<:Gravity_Manipulation:958314009738764328>", 1, 40, (myStats, eStats, mybuff, ebuff, char, enemy, matchStats, notice, embed, user, ...list) => {
