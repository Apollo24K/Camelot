...
import { getCachedUserSchema, getUserWeapons, updateUsersAndCache } from "./queries.js";
...
export const achievements = [ // Type 1: xp, 2: coins, 3: shards, 4: tickets, 5: lootbox, 6: shield slot
    ...
    new achievInfo("The Battle is to the Strong ⅠⅠ", "Reach level 300 with a character", 71, 23, "1,2,3", "xp|400", "coins|10000", "ss shards|12"),
    ...
    new achievInfo("Zero to Hero", "Defeat floor 100 with a D-Tier character", 75, 24, "1,2", "xp|50", "coins|2000"),
    new achievInfo("Zero to Hero", "Defeat floor 200 with a D-Tier character", 76, 24, "1,2", "xp|75", "coins|5000"),
    new achievInfo("Zero to Hero", "Defeat floor 300 with a D-Tier character", 77, 24, "1,2,4", "xp|100", "coins|15000", "ss ticket|1"),
    ...
    new achievInfo("Maxed Out", "Reach max capacity in bank", 82, 26, "2", "coins|2000"),
