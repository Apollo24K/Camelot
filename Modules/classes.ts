...
const skillDescs: SkillDescription[] = [
    ...
    { // Traditionalist
        "active": `Deals true damage (ignores shield) and reduces enemy DEF by **30%** for the attack`,
        "passive": `His ATK increases by **3%** after each round (up to **30%**).`
    },
    { // Asura
        "active": `Heals and increases max HP by **10%**. Can only be used **12** times.`,
    ...
    { "active": `Steals the equivalent of **10%** of his stats from the enemy for **3** rounds.`, "passive": `Has a **33%** chance of healing for **10%** of damage dealt.` },
    { // Rogue
        "active": `Steals the equivalent of **20%** of his stats from the enemy for **4** rounds.`,
    ...
    { // Demonic
        "active": `Enters Archdemon form, in which HP equal to **4%** of max HP is sacrificed for **10** rounds, to gain **20%** increased ATK, MD, CR and CD. These buffs increase by an additional **2%** per round, up to a total of **40%**. Demonic active can only be used after the 6th round.`,
