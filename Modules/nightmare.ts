...
export const nightmares: NightmareInfo[] = [
    ...
    new NightmareInfo(0, "Tidalfish", "summer2025", 30_000, nightmareMobs[0], { accentColor: "#71afe6ff", preSelectedChar: 17689  }),
    new NightmareInfo(1, "Mari the poisonbearer", "summer2025", 40_000, nightmareMobs[1], { accentColor: "#b495a4ff", preSelectedChar: 2 }),
    new NightmareInfo(2, "Sand Golem", "summer2025", 50_000, nightmareMobs[2], { accentColor: "#e0d589ff", preSelectedChar: 3 }),
    new NightmareInfo(3, "Luminous (alter)", "summer2025", 50_000, nightmareMobs[3], { accentColor: "#513f7cff", preSelectedChar: 10517 }),
    new NightmareInfo(4, "Bubble Captain", "summer2025", 50_000, nightmareMobs[4], { accentColor: "#5395ceff", preSelectedChar: 5 }),
    ...
    new NightmareInfo(7, "Victoria the Dragonslayer", "summer2025", 50_000, nightmareMobs[7], { accentColor: "#c26d57ff", preSelectedChar: 6 }),
