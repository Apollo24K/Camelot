    ...
    "19050": {
        ...
        ability: function (myStats, myStatsFixed, eStats, eStatsFixed, mybuff, ebuff, char, enemy, matchStats, notice, embed, message, ...list) {
            ...
            if (this.weaponType === "sword") {
                ...
                dealDamage(eStats, myStats, ebuff, mybuff, matchStats, notice, `✨ **${char.name}** used Musou no Hitotachi! She`, { atkMultiplier: 2.0, critMultiplier: 1.8, critBuff: 1.5, magicDamage: true, combodmg: true, selfdmg: false, selfheal: true, defMultiplier: 0.8, ignoreShield: true });
                if (this.used === 1) {
