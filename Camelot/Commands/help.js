...
module.exports = {
	...
	execute(message, args) {
        ...
        .addField("!stats", `See how many messages you've written`)
        .addField("!anilist, !al", `See featured anime 💖`)
        .addField("!recommend, !rec, !r", `Some anime recommendations`)
        .addField("!emojilist, !el", `Get a list of emojis Camelot can use`)
        .addField("!purge", `Delete messages in bulk`)
        .addField("!avatar, !a", `Get yours or someone else's Profile Picture`)
        .addField("!ping, !pong", `Pong! 🏓 See your Latency`)
        .addField("!cookie", `Get a Cookie 🍪`)
