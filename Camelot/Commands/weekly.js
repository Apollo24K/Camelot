...
module.exports = {
	...
	execute(interaction) {
        ...
        db.serialize(async () => {
            ...
            let addCoins = 0, ssTicket = 0, sTicket = 0;
            ...
            switch (stats.premium) {
                ...
                case 7: addCoins = 100000; sTicket = 12; ssTicket = 6; break;
                default : false; break;
            };
            
            interaction.reply(`Added ${addCoins}<:coins:872926669055356939>${ssTicket === 0 ? ` and ${sTicket}x<:s_ticket:927642487705722890>` : `, ${sTicket}x<:s_ticket:927642487705722890> and ${ssTicket}x<:ss_ticket:927503239396622336>`}`)
            
            await query(`UPDATE users SET coins = coins + ${addCoins}, ssticket = ssticket + ${ssTicket}, sticket = sticket + ${sTicket}, weeklyclaimed = 1 WHERE id = ${interaction.user.id}`);            
        });
