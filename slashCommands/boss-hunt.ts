...
const exportCommand: SlashCommand = {
    ...
    async execute({ interaction, author }) {
        ...
        const embedColor = stats.hpbar === null ? 0x2aad9d : customHpBars[stats.hpbar].color;
