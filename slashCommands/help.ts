            ...
            if (isEventOngoing()) Embed.addFields(
                {
                    name: {
                        ...
                        easter: "🐣 Easter Event",
                    }[ongoingEvent], value: "`/celebrate` `/seasonal shop` `/event pass` `/ex pull`"
                },
            );
            Embed.addFields(
